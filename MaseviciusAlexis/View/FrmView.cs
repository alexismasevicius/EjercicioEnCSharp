...
namespace View
{
    ...
    {
        private const string archivoPath = "carrusel.txt";
        ...
        private void FrmView_Load(object sender, EventArgs e)
        {
            ...
            if (json.ExisteArchivo(archivoPath))
            {
                ...
                catch(ErrorArchivosException ed)
                {
                    MessageBox.Show($"{ed.Message} .... {ed.InnerException.Message}");
                }
                
            }
            this.Text = "Masevicius, Alexis";
        ...
        private void FrmView_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            this.json.Guardar("carrusel.txt", juegos);
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if (!this.ejecutando)
            {
                ...
                {
                   // Task tsk = new Task(item.IniciarCarrusel);
                   // tsk.Start(cancellationToken);
                    Task.Run(() => item.IniciarCarrusel(cancellationToken));
                }
        ...
        private delegate void Callback(object sender, short movimiento);
        private void AvanceJuegos(object sender, short movimiento)
        {
            ...
            {
                Callback callback = new Callback(this.AvanceJuegos);
        ...
        {
            Juego.Velocidad = (short)numericUpDown1.Value;
        }
    }
}
