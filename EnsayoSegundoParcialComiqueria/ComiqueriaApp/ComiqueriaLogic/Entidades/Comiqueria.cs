...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
             ...
             */
            dbcCom = new BaseDatosComic();
            this.productos = dbcCom.SelectAll();
            this.ventas = new List<Venta>();
            BaseDatosComic.EventoDesconocido += ActualizarListaProductos;
        }
        ...
        public void Vender(Producto producto, int cantidad)
        {
            ...
            ruta = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), String.Format(@"Venta_{0}.txt", nuevaVenta.Fecha.ToString("ddMMyyyy_HHmmss")));
            // Punto 6G - Serializar a xml la nueva venta.
            Serializador<Venta>.Guardar(nuevaVenta, ruta);
        }
